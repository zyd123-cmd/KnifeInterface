...
@router.get("/lend-records", response_model=LendRecordResponse)
async def get_teamleader_lend_records(
...
@router.get("/lend-records/export")
...
@router.get("/replenish-records", response_model=ReplenishRecordResponse)
async def get_teamleader_replenish_records(
...
@router.get("/storage-records", response_model=StorageRecordResponse)
async def get_teamleader_storage_records(
    current: Optional[int] = Query(None, description="当前页"),
    end_time: Optional[str] = Query(None, description="结束时间"),
    order: Optional[int] = Query(None, description="顺序 0: 从大到小 1：从小到大"),
    ranking_type: Optional[int] = Query(None, description="0: 数量 1: 金额"),
...
@router.get("/personal-storage", response_model=PersonalStorageResponse)
...
@router.get("/make-alarm", response_model=MakeAlarmResponse)
...
@router.get("/get-make-alarm", response_model=CabinetAlarmResponse)
